<nav class="nav flex-column">
    <!-- <a href="dashboard.php?discord=<?= $_GET["discord"] ?>" class="nav-link"><i class="mdi mdi-view-dashboard"></i> Dashboard</a> -->
    <a href="salaires.php?discord=<?= $_GET["discord"] ?>" class="nav-link"><i class="mdi mdi-cash-multiple"></i> Salaires</a>
